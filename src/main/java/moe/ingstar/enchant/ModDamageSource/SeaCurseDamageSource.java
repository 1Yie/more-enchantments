...
public class SeaCurseDamageSource extends DamageSource {
    ...
    public SeaCurseDamageSource(@Nullable Entity source, @Nullable Entity attacker) {
        super(DAMAGE_TYPE_REGISTRY_ENTRY, source, attacker);
    }

    @Override
    public Text getDeathMessage(LivingEntity killed) {
        return Text.translatable("death.seacurse.killed", killed.getDisplayName());
    }
